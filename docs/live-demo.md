...
1) Scenario: Delete an existing task item from the task list # tests/assurance/features/todo-manager.feature:23
   √ Before # tests/cucumber.support.ts:19
   √ Before # tests/assurance/step-definitions/todo-manager.steps.ts:9
   √ Given a user is on the homepage # tests/assurance/step-definitions/todo-manager.steps.ts:15
   √ And the page contains the following tasks: # tests/assurance/step-definitions/todo-manager.steps.ts:19
       | TASK         |
       | do not touch |
       | complete me  |
       | filler task  |
   ...
   - And card "do not touch" should be displayed in the todo list # tests/assurance/step-definitions/todo-manager.steps.ts:45
   - And card "complete me" should be displayed in the todo list # tests/assurance/step-definitions/todo-manager.steps.ts:45
   √ After # tests/cucumber.support.ts:26
...
`./tests/assurance/step-definitions/todo-manager.steps.ts`. Adjust any suggested parameters for TypeScript and implement your Playwright test code:
